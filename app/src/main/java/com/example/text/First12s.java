...
public class First12s extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        soundID = soundPool.load(this,R.raw.doorbell,1);	//작성, (mp3 파일 이름이 click_sound이다.)
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), Firstend.class);
