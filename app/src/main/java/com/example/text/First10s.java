...
public class First10s extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.first10);
        ...
        soundID = soundPool.load(this,R.raw.train,1);	//작성, (mp3 파일 이름이 click_sound이다.)
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), First11s.class);
